...
const applyPatchFixingIPv6URISerialization = (
  UnpatchedHttpServer: typeof OrigHttpServer
) => {
  var origGetServerAddress = UnpatchedHttpServer.getServerAddress
  ...
  HttpServer.prototype.buildHttpServerApi = (
    server: Parameters<typeof UnpatchedHttpServer.getServerAddress>[0]
  ) => {
